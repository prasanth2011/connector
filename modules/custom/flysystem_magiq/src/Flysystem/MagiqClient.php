...
namespace Drupal\flysystem_magiq\Flysystem\MagiqClient;
...
class MagiqClient
{
 ...
 public function __construct(string $user, string $password) {
   $this->user = ($user)?$user:'test';
   $this->password =($password)?$password: 'demonz';
   $this->client = new SoapClient("https://docs.narrandera.nsw.gov.au/srv.asmx?WSDL");
   $this->authenticate();
 }
 public function authenticate(){
        $params = array('UID'=> $this->user, 'PWD'=> $this->password);
  ...
  {
    $parameters = [
      'SourcePath' => $this->normalizePath($fromPath),
      'DestinationPath' => $this->normalizePath($toPath),
    ];
    return $this->soapEndpointRequest('Copy', $parameters);
  }
  /**
  ...
  public function createFolder(string $path): array
  {
    ...
    $object = $this->soapEndpointRequest('CreateFolder', $parameters);
   // $object['.tag'] = 'folder';
    return $object;
  }
...
/*  public function delete(string $path): array
  ...
  public function download(string $path)
  {
    ...
    $response = $this->contentEndpointRequest('DownloadDocument', $arguments);
  ...
  {
    $parameters = [
      'ItemPath' => $this->normalizePath($path),
    ];
    return $this->soapEndpointRequest('AssociatedDocuments', $parameters);
  }
  /**
  ...
  public function soapEndpointRequest(string $endpoint, array $parameters = null): array
  {
    ...
    $token= array('AuthenticationTicket' => $this ->accessToken);
    $parameters = array_merge($parameters, $token);
    try {
      $options = ['headers' => $this->getHeaders()];
...
$test = new MagiqClient('test', 'demonz');