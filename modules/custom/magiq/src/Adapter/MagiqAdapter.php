...
namespace Drupal\magiq\Adapter;

use League\Flysystem\Adapter\AbstractAdapter;
use League\Flysystem\Adapter\Polyfill\NotSupportingVisibilityTrait;
use League\Flysystem\Config;
use Drupal\magiq\MagiqClient;
use Srmklive\Dropbox\GetMimeType;
use Srmklive\Dropbox\ParseResponse;

class MagiqAdapter extends AbstractAdapter
{
    use GetMimeType, NotSupportingVisibilityTrait, ParseResponse;

    /** @var \Srmklive\Dropbox\Client\MagiqClient */
    protected $client;

    public function __construct(MagiqClient $client, $prefix = '')
    {
        $this->client = $client;
